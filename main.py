...
def game_status(player_total, dealer_total):
    if player_total > 21:
        print(f"You bust with a score of {player_total}. Better luck next time!")
    elif dealer_total > 21:
        print(f"The dealer busts with a score of {dealer_total}. Congratulations, you win!")
    elif player_total == 21:
        print(f"BLACKJACK! You scored a perfect {player_total}! Congratulations, you win!")
